...
const socket = io('https://js-mentor-server-five.vercel.app'); // Connect to the server
...
const Lobby = () => {
  ...
  useEffect(() => {
    fetch('https://js-mentor-server-five.vercel.app/api/codeblocks') // Fetch code blocks from the server
